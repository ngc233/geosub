      ...
      <section className="mx-auto max-w-4xl">
        ...
        <div className="mt-10 grid gap-4">
          {sections.map((section, index) => (
            <section
              key={section.title}
              className="grid gap-4 rounded-lg border border-zinc-200 bg-white p-6 shadow-sm shadow-zinc-950/[0.03] md:grid-cols-[40px_minmax(0,1fr)] md:p-7"
            >
              ...
              <div>
                ...
                <p className="mt-2 max-w-[42rem] text-base leading-8 text-zinc-600">
                  {section.body}
                </p>
              </div>
            </section>
        ...
        <p className="mt-6 max-w-[44rem] rounded-lg border border-zinc-200 bg-zinc-50 px-5 py-4 text-base leading-8 text-zinc-600">
          {note}
        </p>
