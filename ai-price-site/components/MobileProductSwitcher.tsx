  ...
  return (
    <div className="lg:hidden">
      <button
        ...
        className="flex min-h-12 w-full items-center justify-between gap-3 rounded-3xl border border-zinc-200 bg-white/90 px-4 py-3 text-left shadow-sm shadow-zinc-950/[0.04] backdrop-blur transition-all duration-200 ease-out active:scale-[0.99]"
        aria-expanded={open}
      >
      ...
      >
        <div className="min-h-0 overflow-hidden">
          <div className="rounded-3xl border border-zinc-200 bg-white p-3 shadow-sm shadow-zinc-950/[0.04]">
