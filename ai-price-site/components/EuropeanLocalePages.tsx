...
> = {
  fr: {
    home: {
      ...
      description: "GeoSub compare les services d’IA et de streaming selon les pays. Consultez le prix local, son équivalent en dollars, les taxes et le pouvoir d’achat.",
      view: "Découvrir",
      sections: [
    ...
    pages: {
      ...
      privacy: { eyebrow: "Confidentialité", title: "Politique de confidentialité", description: "Les principes appliqués par GeoSub aux données des visiteurs.", heading: "Une collecte limitée", paragraphs: ["GeoSub peut enregistrer des mesures techniques et statistiques nécessaires au fonctionnement, à la sécurité et à l’amélioration du site.", "Nous évitons de collecter des données personnelles inutiles. Les services de mesure éventuellement activés sont indiqués et configurés depuis l’administration."] },
      ...
      "guides/price-guide": { eyebrow: "Guide des prix", title: "Lire un comparatif de prix régional", description: "Comprendre le prix local, la conversion en dollars et l’écart avec la référence.", heading: "Comparer des valeurs cohérentes", paragraphs: ["Commencez par le prix local et sa date de collecte, puis consultez l’équivalent en dollars et la date du taux de change.", "Un prix plus bas ne garantit pas l’accès à l’offre. Les taxes, le pays du compte et le moyen de paiement restent déterminants."] },
  ...
  it: {
    home: {
      ...
      description: "GeoSub confronta servizi IA e streaming tra paesi. Consulta prezzo locale, equivalente in dollari, imposte e potere d’acquisto.", view: "Scopri",
      sections: [
    ...
    pages: {
      ...
      privacy: { eyebrow: "Privacy", title: "Informativa sulla privacy", description: "I principi applicati da GeoSub ai dati dei visitatori.", heading: "Raccolta limitata", paragraphs: ["GeoSub può registrare dati tecnici e statistici necessari per funzionamento, sicurezza e miglioramento del sito.", "Evitiamo dati personali non necessari. Gli eventuali servizi di misurazione vengono indicati e configurati dall’amministrazione."] },
      ...
      "guides/price-guide": { eyebrow: "Guida ai prezzi", title: "Leggere un confronto regionale", description: "Capire prezzo locale, conversione in dollari e differenza dal riferimento.", heading: "Confrontare valori coerenti", paragraphs: ["Parti dal prezzo locale e dalla data di raccolta, poi controlla l’equivalente in dollari e la data del cambio.", "Un prezzo inferiore non garantisce l’accesso: imposte, paese dell’account e metodo di pagamento restano determinanti."] },
  ...
  de: {
    home: {
      ...
      description: "GeoSub vergleicht KI- und Streaming-Dienste nach Land. Sehen Sie lokale Preise, Dollarwerte, Steuern und Kaufkraft.", view: "Ansehen",
      sections: [
    ...
    pages: {
      ...
      "guides/price-guide": { eyebrow: "Preisratgeber", title: "Regionale Preisvergleiche lesen", description: "Lokalen Preis, Dollarwert und Referenzabweichung verstehen.", heading: "Vergleichbare Werte nutzen", paragraphs: ["Beginnen Sie mit dem lokalen Preis und seinem Erhebungsdatum. Prüfen Sie danach Dollarwert und Wechselkursdatum.", "Ein niedrigerer Preis garantiert keinen Zugang. Steuern, Kontoland und Zahlungsmethode bleiben entscheidend."] },
  ...
  pt: {
    home: {
      ...
      description: "O GeoSub compara serviços de IA e streaming entre países. Consulte preço local, equivalente em dólares, impostos e poder de compra.", view: "Explorar",
      sections: [
    ...
    pages: {
      ...
      "guides/price-guide": { eyebrow: "Guia de preços", title: "Ler uma comparação regional", description: "Compreender preço local, conversão em dólares e diferença face à referência.", heading: "Comparar valores coerentes", paragraphs: ["Comece pelo preço local e pela data de recolha; depois consulte o equivalente em dólares e a data do câmbio.", "Um preço mais baixo não garante acesso. Impostos, país da conta e método de pagamento continuam a ser determinantes."] },
