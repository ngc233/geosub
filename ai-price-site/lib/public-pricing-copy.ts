...
const publicPricingCopy = {
  zh: {
    ...
    pricing: {
      appStoreSource: "V1 正式价格源：App Store",
      ...
      allDiagnosticSources: "全部诊断来源",
      allSources: "全部来源",
      webLead: "Web 线索",
      googlePlayLead: "Google Play 线索",
      allDiagnostics: "全部诊断",
      cnyLabel: "人民币 CNY",
      usdLabel: "美元 USD",
      monthlySuffix: "/月",
    ...
    table: {
      ...
      description: (source: string, currency: string) =>
        `V1 正式榜单优先按 App Store 展示；当前视图为 ${source}，按${currency}从低到高排序。`,
      regionCount: (count: number) => `${count} 个地区`,
      allSources: "全部来源",
      webLead: "Web 线索",
      googlePlayLead: "Google Play 线索",
  ...
  en: {
    ...
    pricing: {
      appStoreSource: "V1 official price source: App Store",
      ...
      allDiagnosticSources: "all diagnostic sources",
    ...
    table: {
      ...
      description: (source: string, currency: string) =>
        `GeoSub V1 prioritizes App Store prices. Current view: ${source}, sorted by ${currency} from low to high.`,
      regionCount: (count: number) => `${count} regions`,
      allSources: "All sources",
      webLead: "Web lead",
      googlePlayLead: "Google Play lead",
