...
const preparedPricingListCopy = {
  ja: {
    ...
    aiDescription: "掲載中の ChatGPT、Claude、Gemini の地域別料金を比較します。",
  ...
  ko: {
    ...
    aiLabel: "AI 구독",
    aiDescription: "현재 제공되는 ChatGPT, Claude, Gemini의 국가별 가격을 비교합니다.",
    streamingLabel: "스트리밍",
  ...
  es: {
    ...
    aiDescription: "Compara los precios regionales publicados de ChatGPT, Claude y Gemini.",
  ...
  tr: {
    ...
    aiDescription: "Yayımlanan ChatGPT, Claude ve Gemini bölgesel fiyatlarını karşılaştırın.",
  ...
  ar: {
    ...
    aiDescription: "قارن الأسعار المنشورة لخدمات ChatGPT وClaude وGemini حسب المنطقة.",
  ...
  fr: {
    ...
    aiDescription: "Comparez les prix régionaux publiés de ChatGPT, Claude et Gemini.",
    streamingLabel: "Streaming",
    ...
    card: {
      titleSuffix: "Prix par région", region: "Région", price: "Prix", tax: "Fiscalité", comparison: "vs États-Unis", base: "Référence",
  ...
  it: {
    ...
    aiDescription: "Confronta i prezzi regionali pubblicati di ChatGPT, Claude e Gemini.",
    streamingLabel: "Streaming",
    ...
    card: {
      titleSuffix: "Prezzi per regione", region: "Regione", price: "Prezzo", tax: "Imposte", comparison: "vs USA", base: "Riferimento",
  ...
  de: {
    ...
    aiDescription: "Vergleichen Sie veröffentlichte regionale Preise von ChatGPT, Claude und Gemini.",
    streamingLabel: "Streaming",
    ...
    card: {
      titleSuffix: "Regionale Preise", region: "Region", price: "Preis", tax: "Steuern", comparison: "ggü. USA", base: "Referenz",
  ...
  pt: {
    ...
    aiDescription: "Compare os preços regionais publicados do ChatGPT, Claude e Gemini.",
    streamingLabel: "Streaming",
    ...
    card: {
      titleSuffix: "Preços por região", region: "Região", price: "Preço", tax: "Impostos", comparison: "vs EUA", base: "Referência",
