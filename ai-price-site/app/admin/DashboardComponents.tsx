  ...
  return (
    <div className="space-y-3">
      {items.map((item, index) => {
        const content = (
          <div className="flex items-center justify-between gap-4 rounded-xl border border-slate-200 bg-white px-4 py-3 transition hover:border-blue-200 hover:bg-blue-50/40 dark:border-slate-800 dark:bg-slate-900 dark:hover:border-blue-700 dark:hover:bg-blue-950/40">
            <div className="flex min-w-0 items-center gap-3">
              <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-xl bg-slate-100 text-xs font-bold text-slate-500 dark:bg-slate-800 dark:text-slate-400">
                {index + 1}
              </div>
            ...
            <div className="shrink-0 text-sm font-bold text-slate-700 dark:text-slate-200">
...
export function FunnelSegmentList({
  ...
  return (
    <section className="min-w-0 py-1 lg:px-5 lg:first:pl-0 lg:last:pr-0">
      ...
      <div className="mt-3 divide-y divide-slate-100 border-y border-slate-100 dark:divide-slate-800 dark:border-slate-800">
          ...
          return (
            <div key={item.key} className="py-3">
              <div className="flex items-center justify-between gap-3">
                ...
                <span className="shrink-0 text-xs font-bold text-blue-700 dark:text-blue-300">
        ...
        {items.length === 0 ? (
          <p className="py-6 text-center text-xs text-slate-400 dark:text-slate-400">所选时段暂无数据。</p>
        ) : null}
      </div>
    </section>
  );
