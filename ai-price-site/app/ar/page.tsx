...
export const metadata: Metadata = {
  ...
  description:
    "قارن اشتراكات الذكاء الاصطناعي وخدمات البث حسب الدولة والمنطقة، مع السعر المحلي والقيمة بالدولار ومعلومات الضرائب وسياق القوة الشرائية.",
};
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 md:py-20">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-base leading-8 text-zinc-600 md:text-lg">
            ...
            والمناطق، ويعرض السعر المحلي وقيمته بالدولار والمعلومات الضريبية
