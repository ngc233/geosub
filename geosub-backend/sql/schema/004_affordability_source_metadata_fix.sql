-- GeoSub schema migration. Split from sql/004_affordability_source_metadata_fix.sql; see migration-layout.json.

-- GeoSub affordability source metadata fix
-- Drop and recreate affordability views with income source metadata
