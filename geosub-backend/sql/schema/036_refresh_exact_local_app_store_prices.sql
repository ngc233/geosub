-- GeoSub schema migration. Split from sql/056_refresh_exact_local_app_store_prices.sql; see migration-layout.json.

-- Exact local App Store prices revalidate the subscription price even when
-- exchange-rate movement changes the USD equivalent by more than a fixed
-- percentage. Price changes still remain in the normal stability review.
...
BEGIN
  ...
  refreshed AS (
    ...
    SET
      ...
      source_summary = 'Revalidated exact local App Store price: '
