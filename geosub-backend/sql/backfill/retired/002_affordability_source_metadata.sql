-- GeoSub retired manual migration. Split from sql/004_affordability_source_metadata.sql; see migration-layout.json.

-- GeoSub affordability source metadata
-- Add income source metadata to affordability views
