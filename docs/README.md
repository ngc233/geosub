...
- [rfc-growth-intelligence-api-v1-2026-08-30.md](rfc-growth-intelligence-api-v1-2026-08-30.md)：只读流量增长情报 API、日报/周报门禁、机器身份、隐私和分阶段上线方案。
- [growth-bing-shadow-adapter.md](growth-bing-shadow-adapter.md)：Bing shadow 采集与周报转换说明。
- [growth-google-shadow-adapter.md](growth-google-shadow-adapter.md)：Google Search Console shadow 采集与周报转换说明。
